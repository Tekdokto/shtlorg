...
import { APP_URL, COMPANY_APP_URL } from "constants/defaultValues.js"
  ...
  return (
    <AppBar position="static" className={classes.appBar + appBarClasses}>
      <Toolbar>
        ...
        {!(termspage === window.location.href || privacypage === window.location.href) ? <a href={COMPANY_APP_URL+"/auth/login"}><span className={classes.loginAs}>LOGIN AS COMPANY</span></a> : null}
        <Hidden mdUp mdDown>
          <Button
