...
class Sidebar extends React.Component {
  constructor(props) {
    super(props);
    this.handleLogoutProfile = this.handleLogoutProfile.bind(this);
    this.state = {
      openAvatar: false,
      miniActive: true,
      alert: null,
  ...
  warningWithConfirmAndCancelMessage() {
    ...
    this.setAlert(
      <SweetAlert
        ...
        onConfirm={() => ths.handleLogoutProfile()}
        onCancel={() => ths.setAlert(null)}
        ...
        return (
          ...
          >
            <NavLink
              ...
              onClick={(e)=>this.warningWithConfirmAndCancelMessage()}
            >
              {(prop.icon !== undefined && !prop.iconify) ? (
                typeof prop.icon === "string" ? (
                  ...
                  />
                    ...
                    prop.iconify === true ? (
                      typeof prop.icon !== "string" ? (
                        <IconF icon={prop.icon} className={itemIcon} />
                      ) : (
        ...
        return (
          ...
          >
            <Button
              ...
              onClick={(e)=>this.handleLogoutProfile()}
            >
              {typeof prop.icon === "string" ? (
                <FontAwesome
                  className={itemIcon}
        ...
        <Hidden mdUp implementation="css">
          ...
          >
            ...
            <SidebarWrapper
              ...
              user={user}
              headerLinks={<AdminNavbarLinks rtlActive={rtlActive} {...this.props} />}
              links={links}
            />
            {image !== undefined ? (
              <div
...
export default connect(mapStateToProps, null)(withStyles(combinedStyles)(Sidebar));
