...
export const LIST_CAREER_PATH_SKILL = "LIST_CAREER_PATH_SKILL";
export const LIST_CAREER_PATH_SKILL_SUCCESS = "LIST_CAREER_PATH_SKILL_SUCCESS";
export const LIST_CAREER_PATH_SKILL_FAIL = "LIST_CAREER_PATH_SKILL_FAIL";

export const LIST_STUDENT_SKILL = "LIST_STUDENT_SKILL";
export const LIST_STUDENT_SKILL_SUCCESS = "LIST_STUDENT_SKILL_SUCCESS";
export const LIST_STUDENT_SKILL_FAIL = "LIST_STUDENT_SKILL_FAIL";

export const CHANGE_STUDENT_SKILL_STATUS = "CHANGE_STUDENT_SKILL_STATUS"

export const ADD_STUDENT_SKILL = "ADD_STUDENT_SKILL";
export const ADD_STUDENT_SKILL_SUCCESS = "ADD_STUDENT_SKILL_SUCCESS";
export const ADD_STUDENT_SKILL_FAIL = "ADD_STUDENT_SKILL_FAIL";
...
export const LIST_PREPERATION_VIDEO = "LIST_PREPERATION_VIDEO";
export const LIST_PREPERATION_VIDEO_SUCCESS = "LIST_PREPERATION_VIDEO_SUCCESS";
export const CHANGE_VIDEO_WATCH_STATUS = "CHANGE_VIDEO_WATCH_STATUS";

export const FETCH_MOCK_INTERVIEW_STUDENT_DATA = "FETCH_MOCK_INTERVIEW_STUDENT_DATA";
export const FETCH_MOCK_INTERVIEW_STUDENT_DATA_SUCCESS = "FETCH_MOCK_INTERVIEW_STUDENT_DATA_SUCCESS";
export const FETCH_MOCK_INTERVIEW_STUDENT_DATA_FAIL = "FETCH_MOCK_INTERVIEW_STUDENT_DATA_FAIL";

export const FETCH_ADMIN_INTERVIEW_TIME_SLOT = "FETCH_ADMIN_INTERVIEW_TIME_SLOT";
export const FETCH_ADMIN_INTERVIEW_TIME_SLOT_SUCCESS = "FETCH_ADMIN_INTERVIEW_TIME_SLOT_SUCCESS";
export const FETCH_ADMIN_INTERVIEW_TIME_SLOT_FAIL = "FETCH_ADMIN_INTERVIEW_TIME_SLOT_FAIL";

export const SET_MOCK_INTERVIEW_WITH_ADMIN = "SET_MOCK_INTERVIEW_WITH_ADMIN";
export const SET_MOCK_INTERVIEW_WITH_ADMIN_SUCCESS = "SET_MOCK_INTERVIEW_WITH_ADMIN_SUCCESS";
export const SET_MOCK_INTERVIEW_WITH_ADMIN_FAIL = "SET_MOCK_INTERVIEW_WITH_ADMIN_FAIL";
...
export const EDIT_SPEC_SHEET_DATA = "EDIT_SPEC_SHEET_DATA";
export const EDIT_SPEC_SHEET_DATA_SUCCESS = "EDIT_SPEC_SHEET_DATA_SUCCESS";
