...
import ProfilePic from "../../assets/img/default-avatar.png";
...
export default function HeaderLinks(props) {
  ...
  return (
    <div className={wrapper}>
      ...
      <div className={managerClasses}>
        <img src={ProfilePic} className="top-profile-pic"></img>
        <span className={classes.profileName}>{(localStorage.getItem('userdata'))?JSON.parse(localStorage.getItem('userdata')).first_name+' '+JSON.parse(localStorage.getItem('userdata')).last_name:'Admin'}</span>
        <Button
          color="transparent"
