...
class UserList extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      status_data: [{id: 9, status_name: "Sent"}, {id: 11, status_name: "Rejected"}],
      statusvalue: "",
      companyvalue: "",
      company_data: [],
      interviewdatefrom : "",
  ...
  customsearch(){
    let params =  {}
    let ths= this;
      console.log("this.stateonsubmit",ths.state.interviewdateto > ths.state.interviewdateto)
  ...
  createTablecontent(data) {
    ...
    return (data.length > 0) ? data.map((prop, key) => {
      return {
        ...
        offer_date: prop['offer_date'],
        is_offer_sent: (prop['is_offer_sent'] == 1)?'Rejected':'Sent',   
  ...
  render() {
    ...
    let { companyvalue,statusvalue } = this.state;
    return (
      <div className="main-right-panel">
        <GridContainer>
          <GridItem xs={12} sm={8}>
            <h1>Engineer Report</h1>
            <h5>Offers Engineers</h5>
          </GridItem>
