...
class LoginPage extends Component {
  ...
  componentDidMount() {
    ...
    let password = tempObject
      ? tempObject.password
        ? tempObject.password
        : ""
      : "";
    let checkedA = tempObject
      ? tempObject.checkedA
        ? tempObject.checkedA
        : ""
      : false;
  ...
  onSubmit(e, val = {}) {
    ...
    if (
      ...
      this.verifyLength(val.password, 1)
    ) {
    ...
    } else if (!(this.verifyLength(val.password, 1))) {
        ...
        <GridContainer justify="center" alignItems="center" spacing={10}>
          <GridItem lg={7} md={6} sm={6} className={classes.textCenter}>
            ...
            <p className={classes.logLeftContentP}>
              Shtudy is the leading early talent acquisition platform connecting employers with the most talented Black, LatinX, and Native American tech job seekers in America.
            </p>
            <p className={classes.logLeftContentP}>
              Sign in now to start hiring the best&nbsp;
              <Hidden mdDown>
                <br />
              </Hidden>
              and brightest tech job seekers!
            </p>
            ...
            <form onSubmit={(e) => this.onSubmit(e, { email, password })}>
              <Card login className={classes[cardAnimaton]}>
                ...
                >
                  ...
                  Sign in now to start hiring from the most qualified, reliable diverse tech talent pool.
                  </small>
                </CardHeader>
