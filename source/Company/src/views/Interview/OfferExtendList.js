...
class IntroDiscoveryCallList extends React.Component {
  ...
  constructor(props) {
    ...
    this.redirectSendConfirmation = this.redirectSendConfirmation.bind(this);
    this.state = {
      all_watchlist: [],
      watchlist: "",
      watchlistname: "",
  ...
  async getData(state) {
    ...
    const res = await axios.post(`${API_URL}/company/watchlist/get_offer_extended_list`, get_watchlist, headers);
