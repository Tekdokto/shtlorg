...
import Footer from "components/Footer/FooterInner.js";
...
export default function Dashboard(props) {
  const { ...rest } = props;
  const authUser = useSelector(state => state.authReducer.user, shallowEqual)
          ...
          <div className={classes.content}>
            <div className={classes.container}>
              <Switch>
                ...
                {/* {getRoutes(routes)} */}
                <Redirect from="/company" to="/company/dashboard" />
              </Switch>
            </div>
          </div>
        ) : (
